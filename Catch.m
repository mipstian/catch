...
NSString* const APPLICATION_VERSION = @"1.4";
NSString* const APPLICATION_WEBSITE_URL = @"http://code.google.com/p/catch/";
NSString* const APPLICATION_BUG_REPORT_URL = @"http://code.google.com/p/catch/issues/entry?template=Defect%20report%20from%20user";
NSString* const APPLICATION_FEATURE_REQUEST_URL = @"http://code.google.com/p/catch/issues/entry?template=Feature%20request";
NSString* const APPLICATION_HELP_URL = @"http://code.google.com/p/catch/wiki/Help";
NSString* const SERVICE_URL = @"http://showrss.karmorra.info/";
NSString* const SERVICE_FEED_URL_PREFIX = @"http://showrss.karmorra.info/rss.php?";
